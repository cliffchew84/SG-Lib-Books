...
!(function () {
  ...
  m &&
    ((V = (b.documentElement.doScroll ? /^loaded|^c/ : /^loaded|^i|^c/).test(
      b.readyState,
    )) ||
  ...
  (gt.prototype = {
    ...
    then: function (t, e) {
      ...
      return (
        (!e && !t) ||
          this._handled ||
          ((this._handled = !0), this._state === Q && nt && ot(ht, this)),
  ...
  function jt(t) {
    var e = t.icons,
      ...
      y = [
        et.replacementClass,
        i ? "".concat(et.familyPrefix, "-").concat(i) : "",
        b,
      ]
        .filter(function (t) {
        ...
        a.found && n.found
          ? ((C = (k = K).children),
            ...
            (T = {
              ...
              children: [
                Et(
                  $({ tag: E.tag, attributes: $({}, E.attributes, R.path) }, _),
                ),
              ],
            }),
            (Y = { tag: "g", attributes: $({}, R.outer), children: [T] }),
            (H = "mask-".concat(N || kt())),
            (F = "clip-".concat(N || kt())),
            (D = {
              tag: "mask",
  ...
  function Jt(t) {
    return t.reduce(function (t, e) {
      ...
      if (Gt[e]) t.prefix = e;
        ...
        var a =
          "fa" === t.prefix ? Vt[n] || { prefix: null, iconName: null } : {};
        (t.iconName = a.iconName || n), (t.prefix = a.prefix || t.prefix);
      } else
        e !== et.replacementClass && 0 !== e.indexOf("fa-w-") && t.rest.push(e);
      return t;
    }, Kt());
  }
  function Qt(t, e, n) {
  ...
  var ee = {
    ...
    nest: function (t) {
      ...
      var r = n[0].attributes.class.split(" ").reduce(
        function (t, e) {
          return (
            e === et.replacementClass || e.match(a)
              ? t.toSvg.push(e)
              : t.toNode.push(e),
            t
          );
      ...
      et.mutateApproach === S && (e = v.requestAnimationFrame || ne),
        e(function () {
          var t =
              !0 === et.autoReplaceSvg
                ? ee.replace
                : ee[et.autoReplaceSvg] || ee.replace,
            e = Yt.begin("mutate");
          n.map(t), e(), a();
        });
    }
  ...
  function se(t) {
    ...
    return (
      ...
      o.prefix && 1 < i.length
        ...
        : o.prefix &&
          1 === i.length &&
          (o.iconName = Bt(o.prefix, Ft(t.innerText))),
      o
    );
  }
  var le = function (t) {
      ...
      children: [
        pe,
        {
          ...
          children: [
            ...
            {
              tag: "animate",
              attributes: $({}, he, { values: "1;0;1;1;0;1;" }),
            },
          ],
        },
        {
          ...
          children: [
            {
              tag: "animate",
              attributes: $({}, he, { values: "1;0;0;0;0;1;" }),
            },
          ],
        },
        {
          ...
          children: [
            {
              tag: "animate",
              attributes: $({}, he, { values: "0;0;1;1;0;0;" }),
            },
          ],
        },
      ],
    ...
    return new vt(function (a, t) {
      ...
      if (r && "none" !== o && "" !== o) {
        var c = n.getPropertyValue("content"),
          ...
          f = Bt(s, l),
          u = f;
        if (!f || (e && e.getAttribute(C) === s && e.getAttribute(O) === u))
          a();
        else {
  ...
  var Le,
          ...
          return (
            ...
            Lt({
              ...
              extra: {
                attributes: l,
                styles: u,
                classes: ["".concat(et.familyPrefix, "-layers-text")].concat(
                  d(c),
                ),
              },
            })
          ...
          return (
            ...
            (function (t) {
              ...
              extra: {
                attributes: c,
                styles: l,
                classes: ["".concat(et.familyPrefix, "-layers-counter")].concat(
                  d(i),
                ),
              },
            })
            ...
            [
              {
                tag: "span",
                attributes: {
                  class: ["".concat(et.familyPrefix, "-layers")]
                    .concat(d(n))
                    .join(" "),
                },
                children: e,
    ...
    He = function () {
      var t = (
        ...
        e = void 0 === t ? b : t;
      (0 < Object.keys(W.styles).length || et.autoFetchSvg) &&
        m &&
        et.autoReplaceSvg &&
        Ye.dom.i2svg({ node: e });
    };
  !(function (t) {
    ...
    u &&
      (v.FontAwesome || (v.FontAwesome = Ye),
      X(function () {
        He(),
          ce({
            treeCallback: ke,
