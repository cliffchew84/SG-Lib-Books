...
ALTER TABLE "public"."user_libraries" OWNER TO "postgres";
...
ALTER TABLE ONLY "public"."libraries"
    ADD CONSTRAINT "libraries_pkey" PRIMARY KEY ("name");
...
ALTER TABLE ONLY "public"."user_libraries"
    ADD CONSTRAINT "user_libraries_pkey" PRIMARY KEY ("library_name", "UserName");
...
ALTER TABLE ONLY "public"."books_avail"
    ADD CONSTRAINT "books_avail_BID_fkey" FOREIGN KEY ("BID") REFERENCES "public"."books_info"("BID") ON UPDATE CASCADE ON DELETE CASCADE;



ALTER TABLE ONLY "public"."user_books"
    ADD CONSTRAINT "user_books_BID_fkey" FOREIGN KEY ("BID") REFERENCES "public"."books_info"("BID") ON UPDATE CASCADE ON DELETE CASCADE;



ALTER TABLE ONLY "public"."user_books"
    ADD CONSTRAINT "user_books_UserName_fkey" FOREIGN KEY ("UserName") REFERENCES "public"."users"("UserName") ON UPDATE CASCADE ON DELETE CASCADE;



ALTER TABLE ONLY "public"."user_libraries"
    ADD CONSTRAINT "user_libraries_UserName_fkey" FOREIGN KEY ("UserName") REFERENCES "public"."users"("UserName") ON UPDATE CASCADE ON DELETE CASCADE;



ALTER TABLE ONLY "public"."user_libraries"
    ADD CONSTRAINT "user_libraries_library_name_fkey" FOREIGN KEY ("library_name") REFERENCES "public"."libraries"("name") ON UPDATE CASCADE ON DELETE CASCADE;
...
GRANT ALL ON TABLE "public"."user_libraries" TO "anon";
GRANT ALL ON TABLE "public"."user_libraries" TO "authenticated";
